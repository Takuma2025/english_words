...
function setupEventListeners() {
    ...
    if (wordFilterViewEl) {
        const filterCategoryHeader = wordFilterViewEl.querySelector('.filter-category-header');
        ...
        if (filterCategoryHeader) {
            ...
            filterCategoryHeader.addEventListener('touchstart', (e) => {
                ...
                if (filterSheetContent && filterSheetContent.scrollTop <= 5) {
                    ...
                    e.stopPropagation(); // コンテンツ部分への伝播を防ぐ
                }
            }, { passive: true });
            
            filterCategoryHeader.addEventListener('touchmove', (e) => {
            ...
            filterCategoryHeader.addEventListener('touchend', (e) => {
                if (!isDragging) return;
                isDragging = false;
